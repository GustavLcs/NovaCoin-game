...
function createEmptyShopMessageBr() {
    const itemEl = document.createElement("div");
    itemEl.className = "item-description shop-item";

    const title = document.createElement("h4");
    title.textContent = "Sem melhorias disponíveis";

    const desc = document.createElement("p");
    desc.textContent = "Continue jogando para desbloquear mais!";
...
statsButton.style.marginLeft = "calc(100% - 115px)";
